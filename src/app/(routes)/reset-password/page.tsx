            ...
            <div className="transform transition-all duration-300 hover:scale-[1.01]">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  minLength={8}
                  className="w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white placeholder-gray-400 transition-all pr-12"
              ...
              <p className="text-xs text-gray-400 mt-1">
                Must contain uppercase, lowercase, number (minimum 8 characters)
              </p>
            </div>
